...
static volatile uint8_t register_address_sent;  /* Flag (0/1) whether the register address was already sent */
static volatile uint8_t RW = I2C_WRITE;         /* Read/Write indicator: I2C_READ or I2C_WRITE (defaults to WRITE) */

volatile uint8_t i2c_done_flag;
